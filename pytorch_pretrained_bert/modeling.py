...
class BertAttention(nn.Module):
    ...
    def forward(self, input_tensor, attention_mask, output_attentions=False):
        self_output = self.self(input_tensor, attention_mask, output_attentions=output_attentions)
...
class BertEncoder(nn.Module):
    ...
    def forward(self, hidden_states, attention_mask, output_all_encoded_layers=True, output_attentions=False):
        ...
        for layer_module in self.layer:
            hidden_states = layer_module(hidden_states[0], attention_mask, output_attentions)
            if output_attentions:
                all_self_attentions = all_self_attentions + (hidden_states[1],)
